    ...
    private static Stream<Arguments> provideTestValidation() {
        return Stream.of(
            Arguments.of(
                "name",
                List.of(
                    UpdateContactRequest.builder().name("some name").build()
                ),
                List.of(),
                Map.of()
            ),
            Arguments.of(
                "name",
                List.of(
                    UpdateContactRequest.builder().build()
                ),
            ...
            Arguments.of(
                "name",
                List.of(
                    UpdateContactRequest.builder().name("").build(),
                    UpdateContactRequest.builder().name("  ").build()
                ),
            ...
            Arguments.of(
                "name",
                List.of(
                    UpdateContactRequest.builder().name("ab").build(),
                    UpdateContactRequest.builder().name("a".repeat(101)).build()
                ),
            ...
            Arguments.of(
                "photo",
                List.of(
                    UpdateContactRequest.builder().photo("a".repeat(512)).build()
                ),
                List.of(),
                Map.of()
            ),
            ...
            Arguments.of(
                "bio",
                List.of(
                    UpdateContactRequest.builder().bio("a".repeat(501)).build()
                ),
            ...
            Arguments.of(
                ...
                List.of(
                    UpdateContactRequest.builder().build(),
                    UpdateContactRequest.builder().numbers(List.of()).build()
                ),
